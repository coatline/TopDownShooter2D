...
public class ItemDisplay : MonoBehaviour
{
    ...
    private void Awake()
    {
        slotImageScript = GetComponentInParent<Image>();
    ...
    public void DeSelect()
    {
        ...
        slotImageScript.color = normalColor;
    }
    ...
    public void Select()
    {
        ...
        slotImageScript.color = hightlightedColor;
    }

    public void ChangeItem(Transform playerTransform, Item newItemScript, ItemDisplay selectedSlot)
    {
